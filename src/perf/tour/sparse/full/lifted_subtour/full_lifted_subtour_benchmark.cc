...
SolutionResult FullLiftedSubtourBenchmark::execute(Instance& instance,
                                                   ...
                                                   int timeLimit)
{
  ...
  separator->addSeparator(std::make_unique<SparseLiftedSubtourSeparator>(program, instance.staticCosts));
